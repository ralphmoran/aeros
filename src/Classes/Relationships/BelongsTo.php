 ...
 *
 * Represents an inverse relationship using pivot table.
...
class BelongsTo extends Relationship
{
     ...
     */
    public function __construct(Model $parent, Model $related, string $foreignKey, string $ownerKey, ?string $pivotTable = null)
    {
    ...
    public function get(): ?Model
    {
        ...
        // Query through pivot table (inverse direction)
